...
func (Build) DockerArm64(ctx context.Context) error {
	...
	return sh.RunV("docker", "build", "--build-arg", "TARGET_PLATFORM=linux/arm64", "--build-arg", "COMPILE_GOARCH=arm64", "-t", "slimbean/grafana-kiosk:2023-11-01v2", "-f", "build/Dockerfile", ".")
}
